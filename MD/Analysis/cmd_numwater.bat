...
gmx select -f wt_cis.xtc -s wt_cis.tpr -select "same residue as (resname TIP3 and within 0.5 of resname RET)" -os wt_cis_numwater.xvg -tu ns
gmx select -f wt_trans.xtc -s wt_trans.tpr -select "same residue as (resname TIP3 and within 0.5 of resname RET)" -os wt_trans_numwater.xvg -tu ns